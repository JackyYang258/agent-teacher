...
**How:** include the visualization as a markdown image, ASCII diagram, SVG, or — when Claude can render images — directly. One chart per lesson at most. Place near the example (illustrating the code) or near the trap (illustrating the failure mode).
